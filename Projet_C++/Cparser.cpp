...
map<string, string> CParser::PAR_GetCleValeur()
{
	...
	map<string, string>::iterator it = mValeurs.begin();
...
map<string, vector<string>> CParser::PAR_GetCleListeValeur()
{
	ifstream fichier(sPARChemin);
	string sOk;
	map<string, string> mValeurs;
